...
const STACK_MAX = 16;
const FILL_STACK_UNDEFINED = new Array(STACK_MAX).fill(undefined);
class StateProxyHandler {
    #version;
    #pathManager;
    #stateValueManager;
    #indexes = new Array(STACK_MAX).fill(undefined);
    #validIndexSize = 0;
    // ['$1': 0, '$2': 1, '$3': 2, ...]
    #indexByIndexName = {};
    constructor(version, pathManager, stateValueManager) {
    ...
    setRef(info, listIndex, callback) {
        this.#validIndexSize = listIndex?.length ?? 0;
        if (listIndex !== null) {
